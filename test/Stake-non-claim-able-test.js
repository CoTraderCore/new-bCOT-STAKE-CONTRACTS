...
//     })
//
//     it('Cannot burn rewards if stake have not destributed shares', async function() {
//       // stake
//       const toStake = await pair.balanceOf(userOne)
//       await pair.approve(stakeNonClaim.address, toStake)
//       await stakeNonClaim.stake(toStake)
//       await stakeNonClaim.burnRemainsRewards()
...
//     })
//
//     it('Not reward destributor can not call burnRemainsRewards', async function() {
//       // stake
//       const toStake = await pair.balanceOf(userOne)
//       await pair.approve(stakeNonClaim.address, toStake)
//       await stakeNonClaim.stake(toStake)
//       await stakeNonClaim.withdraw(toStake)
//       await stakeNonClaim.burnRemainsRewards({from:userTwo})
//       .should.be.rejectedWith(EVMRevert)
//     })
//   })
//
